 ...
 * @version 25.11.2015  12:24 Uhr Anpassungen für Server
 */
    ...
    function render($mode, &$renderer, $indata) {
       ...
       global $filename;
        ...
        if($mode == 'xhtml'){
            ...
            // print "<hr>A Hello World: <br>$state $match<br>";
            switch ($state) {
...
//                  $renderer->doc .= $match . ' title=' . $match . ' class="notexist">' . basename($match);
                  /**
                    * Auf Win-Systemen muss ebenfalls mit dem "/" gearbeitet 
                    * werden, da DokuWiki auf einem Linux-System laeuft.
                    */                    
